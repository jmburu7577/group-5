...
import { allProducts, featuredArtisans, type Product } from '@/lib/data';
...
export default function ComparePage() {
    ...
    type ComparisonFeature = {
        key: keyof Product;
        label: string;
        type: 'text' | 'price' | 'rating' | 'artisan' | 'list' | 'tags' | 'description' | 'stock';
    };
                        ...
                        <div className="mt-12">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6">
                                <p className="text-gray-600 text-center">
                                    Based on your comparison, we will show you similar products here.
                                </p>
